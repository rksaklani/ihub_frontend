...
const SuperAdminInTangible = () => {
  ...
  //     navigate(ROUTES.SUPER_ADMIN_TANGIBLE_ITEM); // Navigate to Tangible Item Page
  //   } else {
  ...
  return (
    <div>
      <Breadcrumb pageName="In-Tangible" />
...
export default SuperAdminInTangible;
