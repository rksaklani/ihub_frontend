...
import {  usePostSignupMutation } from '../../store/api/auth/auth.api';
...
export const SignUp: React.FC = () => {
  ...
  const handleSubmit = async () => {
    try {
      await postSignup({ name, email, password, role }).unwrap();
                ...
                <div className="mt-6 text-center">
                  <p>
                   Already have an account ? {}
                    <Link to={ROUTES.LOGIN_PAGE} className="text-primary">
                      Sign In
                    </Link>
                  </p>
                </div>
