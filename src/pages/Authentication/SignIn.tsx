...
import { usePostLoginMutation } from '../../store/api/auth/auth.api';
...
<div className="h-screen w-screen bg-gray-100 flex items-center justify-center">
  <div className="rounded-sm shadow-default w-full max-w-4xl mx-4">
    <div className="flex flex-wrap items-center">
      ...
      <div className="w-full xl:w-1/2 border-stroke xl:border-l-2 p-4">
          ...
          <form>
              ...
              <div className="relative">
                <div className="p-4">
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-4 pr-8 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  >
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-stroke bg-transparent py-3 pl-4 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:text-white dark:focus:border-primary"
                />
            ...
            {/* <div className="mt-6 text-center">
              <p>
                ...
                <Link to={ROUTES.SIGNUP_PAGE} className="text-primary">
                  Sign Up
                </Link>
              </p>
            </div> */}
